...
function appendAll(){
  resortData.response.forEach(function(resort){
    $("#all-card-data").append(`
      ...
      <img id="event-cover-image" src=${resort.snowstake_url} class="img-thumbnail" style="width:90vw;">
      `
    )
  })
}
      ...
      `<div class="card" style=" text-align:center;">
        ...
        <div id="collapse${i}" class="collapse" role="tabpanel" aria-labelledby="heading${i}" data-parent="#accordion">
          <div class="card-body" style="text-align:center;">
            <img id="event-cover-image" src=${resorts[i].snowstake_url} class="img-thumbnail" style="width:90vw;">
          </div>
        </div>
      </div>
      <br>`
